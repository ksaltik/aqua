			...
			if ($level <= $max_level) {
				...
				foreach ($category['parent_cats'][$parent] as $cat_id) {
					...
					if (!isset($category['parent_cats'][$cat_id])) {
						$html .= "<li class='level-".$level. $_cls_visible."'>\n  <a title=".$category['categories'][$cat_id]['name']." href='" . $category['categories'][$cat_id]['url'] . "'>" . $category['categories'][$cat_id]['name']. "</a>\n</li> \n";
					}
					if (isset($category['parent_cats'][$cat_id])) {
						$html .= "<li class='level-".$level. $_cls_visible." have-sub'>\n  <a  title=".$category['categories'][$cat_id]['name']." href='" . $category['categories'][$cat_id]['url'] . "'>" . $category['categories'][$cat_id]['name']. "</a> \n";
