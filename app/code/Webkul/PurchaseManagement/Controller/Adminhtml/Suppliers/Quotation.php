...
class Quotation extends \Webkul\PurchaseManagement\Controller\Adminhtml\Suppliers
{
    /**
    ...
    public function execute()
    {
        ...
        // $resultLayout->getLayout()->getBlock('purchasemanagement.suppliers.edit.tab.quotation');
        return $resultLayout;
    }
}
