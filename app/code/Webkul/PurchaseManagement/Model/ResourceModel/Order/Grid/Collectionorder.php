 ...
 */
namespace Webkul\PurchaseManagement\Model\ResourceModel\Order\Grid;

use Magento\Framework\Api\Search\SearchResultInterface as SearchInterface;
use Magento\Framework\Search\AggregationInterface;
use Webkul\PurchaseManagement\Model\ResourceModel\Order\Collection as OrderCollection;

class Collectionorder extends OrderCollection implements SearchInterface
{
    /**
    ...
    protected function _renderFiltersBefore()
    {
        ...
        $this->addFieldToFilter('status',["in"=>[2,3]]);
