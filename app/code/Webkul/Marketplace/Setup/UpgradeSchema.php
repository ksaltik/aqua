...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        /**
         * Update table 'marketplace_userdata' to add columns
         Added By :Bhagyashree Surana
         Dated : 25-Dec-2017
         For addding new fields in seller profile
         */
         /*Sunarc Technologies Code Starts*/
        $setup->getConnection()->addColumn(
            $setup->getTable('marketplace_userdata'),
            'postal_code',
            [
                ...
                'nullable' => true,
                'comment' => 'Postal code for seller'
            ]
        );
        $setup->getConnection()->addColumn(
            $setup->getTable('marketplace_userdata'),
            ...
            [
                ...
                'nullable' => true,
                'default' => null,
                'comment' => 'delivered to for seller'
            ]
        );
