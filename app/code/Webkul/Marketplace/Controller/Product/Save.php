        ...
        if ($isPartner == 1) {
            ...
            try {
                ...
                if ($this->getRequest()->isPost()) {
                    ...
                    if(empty(trim($wholedata['product']['quantity_and_stock_status']['min_sale_qty'])) || $wholedata['product']['quantity_and_stock_status']['min_sale_qty'] < 1) {
                        $wholedata['product']['quantity_and_stock_status']['min_sale_qty']=1;
                    }
                 //   $wholedata['product']['quantity_and_stock_status']['min_sale_qty']=5;
