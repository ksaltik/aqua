        ...
        if ($order->getState() == 'complete') {
            ...
            */
            ...
            foreach ($ordercollection as $item) {
             ...
             /*Dropshipping Product purchase only single and there payment method should be sample_gateway*/
             if($paymentCode=='sample_gateway'){
                 $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
                 $sunarcHelper = $objectManager->create('\Sunarc\Vendor\Helper\Drop');
                 $sunarcHelper->checkOrder($lastOrderId,$order->getCustomerId());
             }
            /*Dropshipping Product Close*/
        }
    }
}
