...
class CommissionTab extends Generic implements TabInterface
{
    ...
    public function initForm()
    {
       ...
       // $vendorRowCom='';
        ...
        /*For Vendor Added by Pushpendra*/
        ...
        /*$fieldset->addField(
            ...
            [
                'name' => 'vendor_enable',
                'data-form-part' => $this->getData('target_form'),
                'label' => __('Change Commission(Vendor)'),
                'title' => __('Change Commission'),
                'onchange' => 'this.value = this.checked;',
                'after_element_html' => "<script>
                require([
                    ...
                    $('#marketplace_vendor_enable').on('change', function () {
                        if (this.checked === true) {
                            $('#marketplace_vendor_commission').removeAttr('disabled');
                        } else {
                            $('#marketplace_vendor_commission').attr('disabled', 'disabled');
                        }
                    });
                });
                </script>"
        ...
        $fieldset->addField(
            ...
            [
                ...
                'data-form-part' => $this->getData('target_form'),
                'label' => __('Set Commission In Percentage For This Seller(Admin Product)'),
                'title' => __('Set Commission In Percentage For This Seller(Admin Product)'),
                'class' => 'validate-number',
                'disabled' => 'disabled',
                'value' => $vendorRowCom,
            ]
