...
use Webkul\MarketplaceBaseShipping\Model\ResourceModel\ShippingSetting\CollectionFactory as ShippingSettingCollectionFactory;
...
class ShippingSettingRepository implements ShippingSettingRepositoryInterface
{
     ...
     * @throws \Magento\Framework\Exception\NoSuchEntityException
     */
    public function getBySellerId($sellerId, $storeId = null)
    {
        $shippingSetting = $this->shippingSettingFactory->create()
            ->getCollection();
        if ($storeId !== null) {
            $shippingSetting->addFieldToFilter('store_id', ['eq' => $storeId]);
        }
