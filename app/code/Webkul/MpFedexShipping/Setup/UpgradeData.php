...
class UpgradeData implements UpgradeDataInterface
{
    ...
    public function upgrade(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (!count($this->controllersRepository->getByPath('mpfedex/shipping/view'))) {
            $data[] = [
                'module_name' => 'Webkul_MpFedexShipping',
                'controller_path' => 'mpfedex/shipping/view',
                'label' => 'Manage Fedex Shipping',
                'is_child' => '0',
                'parent_id' => '0',
            ];
        }
