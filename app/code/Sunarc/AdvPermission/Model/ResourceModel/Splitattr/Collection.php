 ...
 * @license
 */
namespace Sunarc\AdvPermission\Model\ResourceModel\Splitattr;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'Sunarc_AdvPermission_splitattr_collection';
    ...
    {
        $this->_init(
            \Sunarc\AdvPermission\Model\Splitattr::class,
            \Sunarc\AdvPermission\Model\ResourceModel\Splitattr::class
        );
    }
