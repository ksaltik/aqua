<?php
/**
 * Sunarc_AdvSplitorder extension
 * NOTICE OF LICENSE
 *
 ...
 *
 * @category  Sunarc
 * @package   Sunarc_AdvSplitorder
 * @copyright Copyright (c) 2017
 * @license
 */
namespace Sunarc\AdvPermission\Model\ResourceModel;
...
class Splitattr extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('Sunarc_AdvPermission_splitattr', 'splitattr_id');
    }
     ...
     *
     * @param \Magento\Framework\Model\AbstractModel|\Sunarc\AdvSplitorder\Model\Splitattr $object
     * @return $this
     */
