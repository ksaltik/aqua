<?php
namespace Sunarc\AdvPermission\Model\ResourceModel\Page\Grid;

use Magento\Cms\Model\ResourceModel\Page\Grid\Collection as OriginalCollection;
use Magento\Framework\Data\Collection\Db\FetchStrategyInterface as FetchStrategy;
use Magento\Framework\Data\Collection\EntityFactoryInterface as EntityFactory;
use Magento\Framework\Event\ManagerInterface as EventManager;
use Psr\Log\LoggerInterface as Logger;
use Magento\Cms\Model\ResourceModel\Page\Collection as BlockCollection;
...
//        $splitAttributeRestrictions = explode(',', $user->getSplitattributeRestrictions());
        ...
        $orderIds = $objectManager->create('Sunarc\AdvPermission\Helper\Data')->getRestrictPageCollectionByScope();
        if(isset($orderIds) && $orderIds)
        $this->addFieldToFilter('page_id', ['in'=>$orderIds]);
