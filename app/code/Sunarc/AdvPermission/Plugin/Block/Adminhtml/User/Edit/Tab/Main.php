...
namespace Sunarc\AdvPermission\Plugin\Block\Adminhtml\User\Edit\Tab;
...
class Main
{
    ...
    public function aroundGetFormHtml(
        ...
        if (is_object($form)) {
            if ($objectManager->create('Sunarc\AdvPermission\Helper\Data')->canRestrictBySplitAttribute($model)) {
                ...
                $fieldset->addField(
                    ...
                    [
                        ...
                        'label' => __('Restrict by Splitorder Attribute'),
                        'id' => 'splitattribute_restrictions',
                        'title' => __('Restrict user'),
                        'value' => $currentCategories,//for selected value
                        'values' => $objectManager->create('Sunarc\AdvPermission\Helper\Data')->getProductAttributeValuesForForm()//for all options
                    ]
                );
