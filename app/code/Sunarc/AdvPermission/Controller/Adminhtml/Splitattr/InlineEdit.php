...
class InlineEdit extends \Sunarc\AdvPermission\Controller\Adminhtml\Splitattr
{
    /**
     * Core registry
     *
     ...
     *
     * @var \Sunarc\AdvPermission\Model\ResourceModel\Splitattr
     */
     ...
     * @param \Sunarc\AdvPermission\Model\ResourceModel\Splitattr $splitattrResourceModel
     */
    public function __construct(
        ...
        \Sunarc\AdvPermission\Model\ResourceModel\Splitattr $splitattrResourceModel
    ) {
    ...
    public function execute()
    {
        ...
        foreach (array_keys($postItems) as $splitattrId) {
            /** @var \Sunarc\AdvPermission\Model\Splitattr|\Sunarc\AdvPermission\Api\Data\SplitattrInterface $splitattr */
            ...
            try {
                ...
                $this->dataObjectHelper->populateWithArray($splitattr, $splitattrData, \Sunarc\AdvPermission\Api\Data\SplitattrInterface::class);
     ...
     * @return string
     */
    protected function getErrorWithSplitattrId(\Sunarc\AdvPermission\Api\Data\SplitattrInterface $splitattr, $errorText)
    {
