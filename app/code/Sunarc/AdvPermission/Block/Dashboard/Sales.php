 ...
 */
namespace Sunarc\AdvPermission\Block\Dashboard;
...
class Sales extends \Magento\Backend\Block\Dashboard\Bar
{
 ...
 $storeIds = $objectManager->create('Sunarc\AdvPermission\Helper\Data')->getScopeValuesForForm();
        $collection = $this->_collectionFactory->create()->calculateSales($isFilter);
if(isset($storeIds) && isset($storeIds[0])){    
     $this->getRequest()->setParam('store',$storeIds[0]);
         }
