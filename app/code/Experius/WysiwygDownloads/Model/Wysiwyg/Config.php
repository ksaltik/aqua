 ...
 */
namespace Experius\WysiwygDownloads\Model\Wysiwyg;
        ...
        if ($this->_authorization->isAllowed('Magento_Cms::media_gallery')) {
            $config->addData(
                [
                    ...
                    'files_browser_window_url1' => $this->_backendUrl->getUrl('cms/wysiwyg_images/index/video/1'),
                    'files_browser_window_width' => '100%',//$this->_windowSize['width'],
                    'files_browser_window_height' =>'500px'// $this->_windowSize['height'],
                ]
            );
        }
